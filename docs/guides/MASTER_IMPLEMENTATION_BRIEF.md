...
For the complete link map to every spec, planning doc, and checklist, use [DOCUMENTATION_INDEX.md](/home/sabir/projects/cortexos/docs/guides/DOCUMENTATION_INDEX.md).
...
- `PHASE2_...` through `PHASE17_...` checklist files under `docs/checklists/`
...
1. read this brief
2. read [PHASE1_BOOTSTRAP_CHECKLIST.md](/home/sabir/projects/cortexos/docs/checklists/PHASE1_BOOTSTRAP_CHECKLIST.md)
3. implement only Phase 1 first
4. verify Phase 1 gates
5. then continue to [PHASE2_RUST_FOUNDATION_CHECKLIST.md](/home/sabir/projects/cortexos/docs/checklists/PHASE2_RUST_FOUNDATION_CHECKLIST.md), and so on
